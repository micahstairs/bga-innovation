...
# Age 1
extract_hexagon "10" "$TR" "000"
extract_hexagon "1" "$TR" "001"
extract_hexagon "7" "$TR" "002"
extract_hexagon "4" "$TR" "003"
extract_hexagon "13" "$TR" "004"

# Age 2
extract_hexagon "22" "$TR" "005"
extract_hexagon "16" "$TR" "006"
extract_hexagon "20" "$TR" "007"
extract_hexagon "18" "$TR" "008"
extract_hexagon "24" "$TR" "009"

# Age 3
extract_hexagon "32" "$TR" "010"
extract_hexagon "26" "$TR" "011"
extract_hexagon "30" "$TR" "012"
extract_hexagon "28" "$TR" "013"
extract_hexagon "34" "$TR" "014"

# Age 4
extract_hexagon "42" "$TR" "015"
extract_hexagon "36" "$TR" "016"
extract_hexagon "40" "$TR" "017"
extract_hexagon "38" "$TR" "018"
extract_hexagon "44" "$TR" "019"

# Age 5
extract_hexagon "52" "$TR" "020"
extract_hexagon "46" "$TR" "021"
extract_hexagon "50" "$TR" "022"
extract_hexagon "48" "$TR" "023"
extract_hexagon "54" "$TR" "024"

# Age 6
extract_hexagon "62" "$TR" "025"
extract_hexagon "56" "$TR" "026"
extract_hexagon "60" "$TR" "027"
extract_hexagon "58" "$TR" "028"
extract_hexagon "64" "$TR" "029"

# Age 7
extract_hexagon "72" "$TR" "030"
extract_hexagon "66" "$TR" "031"
extract_hexagon "70" "$TR" "032"
extract_hexagon "68" "$TR" "033"
extract_hexagon "74" "$TR" "034"

# Age 8
extract_hexagon "82" "$TR" "035"
extract_hexagon "76" "$TR" "036"
extract_hexagon "80" "$TR" "037"
extract_hexagon "78" "$TR" "038"
extract_hexagon "84" "$TR" "039"

# Age 9
extract_hexagon "92" "$TR" "040"
extract_hexagon "86" "$TR" "041"
extract_hexagon "90" "$TR" "042"
extract_hexagon "88" "$TR" "043"
extract_hexagon "94" "$TR" "044"

# Age 10
extract_hexagon "102" "$TR" "045"
extract_hexagon "96" "$TR" "046"
extract_hexagon "100" "$TR" "047"
extract_hexagon "98" "$TR" "048"
extract_hexagon "104" "$TR" "049"

# Age 11
extract_hexagon "112" "$TR" "050"
extract_hexagon "106" "$TR" "051"
extract_hexagon "110" "$TR" "052"
extract_hexagon "108" "$TR" "053"
extract_hexagon "114" "$TR" "054"
...
# Age 1
extract_hexagon "13" "$BL" "012"
extract_hexagon "14" "$BL" "013"
extract_hexagon "15" "$TL" "014"
extract_hexagon "7" "$BR" "006"
extract_hexagon "8" "$BC" "007"
extract_hexagon "9" "$BC" "008"
extract_hexagon "4" "$TL" "009"
extract_hexagon "5" "$BL" "010"
extract_hexagon "6" "$BC" "011"
extract_hexagon "1" "$TL" "003"
extract_hexagon "2" "$BC" "004"
extract_hexagon "3" "$BC" "005"
extract_hexagon "10" "$TL" "000"
extract_hexagon "11" "$BR" "001"
...
# Age 2
extract_hexagon "24" "$BC" "023"
extract_hexagon "25" "$BR" "024"
extract_hexagon "20" "$TL" "019"
extract_hexagon "21" "$BL" "020"
extract_hexagon "18" "$BC" "021"
extract_hexagon "19" "$BR" "022"
extract_hexagon "16" "$BL" "017"
extract_hexagon "17" "$TL" "018"
extract_hexagon "22" "$BL" "015"
extract_hexagon "23" "$BR" "016"

# Age 3
extract_hexagon "34" "$TL" "033"
extract_hexagon "35" "$TL" "034"
extract_hexagon "30" "$BL" "029"
extract_hexagon "31" "$BC" "030"
extract_hexagon "28" "$BR" "031"
extract_hexagon "29" "$BC" "032"
extract_hexagon "26" "$TL" "027"
extract_hexagon "27" "$BC" "028"
extract_hexagon "32" "$TL" "025"
extract_hexagon "33" "$BL" "026"
...
extract_hexagon "44" "$BC" "043"
extract_hexagon "45" "$BC" "044"
extract_hexagon "40" "$BL" "039"
extract_hexagon "41" "$BR" "040"
extract_hexagon "38" "$BR" "041"
extract_hexagon "39" "$TL" "042"
extract_hexagon "36" "$BC" "037"
extract_hexagon "37" "$BC" "038"
extract_hexagon "42" "$BR" "035"
extract_hexagon "43" "$TL" "036"

# Age 5
extract_hexagon "54" "$BC" "053"
extract_hexagon "55" "$BR" "054"
extract_hexagon "50" "$BL" "049"
extract_hexagon "51" "$BR" "050"
extract_hexagon "48" "$BL" "051"
extract_hexagon "49" "$TL" "052"
extract_hexagon "46" "$BR" "047"
extract_hexagon "47" "$BC" "048"
extract_hexagon "52" "$BC" "045"
extract_hexagon "53" "$TL" "046"

# Age 6
extract_hexagon "64" "$TL" "063"
extract_hexagon "65" "$BC" "064"
extract_hexagon "60" "$BC" "059"
extract_hexagon "61" "$TL" "060"
extract_hexagon "58" "$BR" "061"
extract_hexagon "59" "$BL" "062"
extract_hexagon "56" "$BC" "057"
extract_hexagon "57" "$BR" "058"
extract_hexagon "62" "$BL" "055"
extract_hexagon "63" "$BR" "056"

# Age 7
extract_hexagon "74" "$TL" "073"
extract_hexagon "75" "$BC" "074"
extract_hexagon "70" "$BC" "069"
extract_hexagon "71" "$TL" "070"
extract_hexagon "68" "$BR" "071"
extract_hexagon "69" "$BL" "072"
extract_hexagon "66" "$BR" "067"
extract_hexagon "67" "$TL" "068"
extract_hexagon "72" "$BC" "065"
extract_hexagon "73" "$BL" "066"

# Age 8
extract_hexagon "84" "$BC" "083"
extract_hexagon "85" "$BL" "084"
extract_hexagon "80" "$BR" "079"
extract_hexagon "81" "$BL" "080"
extract_hexagon "78" "$TL" "081"
extract_hexagon "79" "$BR" "082"
extract_hexagon "76" "$BC" "077"
extract_hexagon "77" "$BL" "078"
extract_hexagon "82" "$TL" "075"
extract_hexagon "83" "$TL" "076"

# Age 9
extract_hexagon "94" "$TL" "093"
extract_hexagon "95" "$BC" "094"
extract_hexagon "90" "$BR" "089"
extract_hexagon "91" "$BR" "090"
extract_hexagon "88" "$BL" "091"
extract_hexagon "89" "$TL" "092"
extract_hexagon "86" "$BR" "087"
extract_hexagon "87" "$TL" "088"
extract_hexagon "92" "$BL" "085"
extract_hexagon "93" "$BC" "086"

# Age 10
extract_hexagon	"104" "$BC" "103"
extract_hexagon	"105" "$BL" "104"
extract_hexagon	"100" "$BL" "099"
extract_hexagon "101" "$BC" "100"
extract_hexagon "98" "$BL" "101"
extract_hexagon "99" "$BR" "102"
extract_hexagon "96" "$TL" "097"
extract_hexagon "97" "$TL" "098"
extract_hexagon "102" "$TL" "095"
extract_hexagon	"103" "$BR" "096"
...
extract_hexagon "114" "$TL" "113"
extract_hexagon "115" "$BL" "114"
extract_hexagon "110" "$TL" "109"
extract_hexagon "111" "$BR" "110"
extract_hexagon "108" "$TL" "111"
extract_hexagon "109" "$BC" "112"
extract_hexagon "106" "$BR" "107"
extract_hexagon "107" "$BL" "108"
extract_hexagon "112" "$BR" "105"
extract_hexagon "113" "$TL" "106"
...
extract_hexagon "6" "$TL" "011"
extract_hexagon "1" "$BC" "003"
extract_hexagon "2" "$BL" "004"
extract_hexagon "3" "$TL" "005"
extract_hexagon "10" "$BL" "000"
extract_hexagon "11" "$BL" "001"
extract_hexagon "12" "$BR" "002"

# Age 2
extract_hexagon "24" "$TL" "023"
extract_hexagon "25" "$BL" "024"
extract_hexagon "20" "$TL" "019"
extract_hexagon "21" "$BL" "020"
extract_hexagon "18" "$BC" "021"
extract_hexagon "19" "$BR" "022"
extract_hexagon "16" "$BC" "017"
extract_hexagon "17" "$BC" "018"
extract_hexagon "22" "$BL" "015"
extract_hexagon "23" "$BR" "016"

# Age 3
extract_hexagon "34" "$BL" "033"
extract_hexagon "35" "$TL" "034"
extract_hexagon "30" "$BL" "029"
extract_hexagon "31" "$BC" "030"
extract_hexagon "28" "$BC" "031"
extract_hexagon "29" "$TL" "032"
extract_hexagon "26" "$TL" "027"
extract_hexagon "27" "$BL" "028"
extract_hexagon "32" "$BR" "025"
extract_hexagon "33" "$BC" "026"

# Age 4
extract_hexagon "44" "$BR" "043"
extract_hexagon "45" "$BC" "044"
extract_hexagon "40" "$TL" "039"
extract_hexagon "41" "$BC" "040"
extract_hexagon "38" "$BC" "041"
extract_hexagon "39" "$BL" "042"
extract_hexagon "36" "$BR" "037"
extract_hexagon "37" "$BL" "038"
extract_hexagon "42" "$BR" "035"
extract_hexagon "43" "$TL" "036"
...
extract_hexagon "46" "$BR" "047"
extract_hexagon "47" "$BR" "048"
extract_hexagon "52" "$TL" "045"
extract_hexagon "53" "$BR" "046"

# Age 6
extract_hexagon "64" "$BR" "063"
extract_hexagon "65" "$TL" "064"
extract_hexagon "60" "$BL" "059"
extract_hexagon "61" "$BC" "060"
extract_hexagon "58" "$TL" "061"
extract_hexagon "59" "$BR" "062"
extract_hexagon "56" "$TL" "057"
extract_hexagon "57" "$BL" "058"
extract_hexagon "62" "$BR" "055"
extract_hexagon "63" "$BC" "056"

# Age 7
extract_hexagon "74" "$TL" "073"
extract_hexagon "75" "$BR" "074"
extract_hexagon "70" "$BR" "069"
extract_hexagon "71" "$BL" "070"
extract_hexagon "68" "$BC" "071"
extract_hexagon "69" "$TL" "072"
extract_hexagon "66" "$BL" "067"
extract_hexagon "67" "$TL" "068"
extract_hexagon "72" "$BC" "065"
extract_hexagon "73" "$TL" "066"
...
extract_hexagon "84" "$BC" "083"
extract_hexagon "85" "$BR" "084"
extract_hexagon "80" "$BC" "079"
extract_hexagon "81" "$BR" "080"
extract_hexagon "78" "$BL" "081"
extract_hexagon "79" "$BR" "082"
extract_hexagon "76" "$BL" "077"
extract_hexagon "77" "$TL" "078"
extract_hexagon "82" "$BC" "075"
extract_hexagon "83" "$TL" "076"

# Age 9
extract_hexagon "94" "$TL" "093"
extract_hexagon "95" "$BL" "094"
extract_hexagon "90" "$BR" "089"
extract_hexagon "91" "$TL" "090"
extract_hexagon "88" "$BC" "091"
extract_hexagon "89" "$TL" "092"
...
# Age 10
extract_hexagon	"104" "$BL" "103"
extract_hexagon	"105" "$TL" "104"
extract_hexagon	"100" "$BC" "099"
extract_hexagon "101" "$TL" "100"
extract_hexagon "98" "$BL" "101"
extract_hexagon "99" "$TL" "102"
extract_hexagon "96" "$BR" "097"
extract_hexagon "97" "$BR" "098"
extract_hexagon "102" "$BC" "095"
extract_hexagon	"103" "$BR" "096"

# Age 11
extract_hexagon "114" "$TL" "113"
extract_hexagon "115" "$BC" "114"
extract_hexagon "110" "$TL" "109"
extract_hexagon "111" "$BL" "110"
extract_hexagon "108" "$TL" "111"
extract_hexagon "109" "$BC" "112"
extract_hexagon "106" "$BR" "107"
extract_hexagon "107" "$BC" "108"
extract_hexagon "112" "$BR" "105"
extract_hexagon "113" "$BC" "106"
...
extract_hexagon "13" "$TL" "012"
extract_hexagon "14" "$TL" "013"
extract_hexagon "15" "$BC" "014"
extract_hexagon "7" "$BC" "006"
extract_hexagon "8" "$BC" "007"
extract_hexagon "9" "$BR" "008"
extract_hexagon "4" "$TL" "009"
extract_hexagon "5" "$BL" "010"
extract_hexagon "6" "$BC" "011"
extract_hexagon "1" "$BL" "003"
extract_hexagon "2" "$BC" "004"
extract_hexagon "3" "$BC" "005"
extract_hexagon "10" "$BL" "000"
extract_hexagon "11" "$BC" "001"
extract_hexagon "12" "$TL" "002"

# Age 2
extract_hexagon "24" "$BL" "023"
extract_hexagon "25" "$TL" "024"
extract_hexagon "20" "$TL" "019"
extract_hexagon "21" "$BR" "020"
extract_hexagon "18" "$BL" "021"
extract_hexagon "19" "$BC" "022"
extract_hexagon "16" "$BC" "017"
extract_hexagon "17" "$TL" "018"
extract_hexagon "22" "$BC" "015"
extract_hexagon "23" "$BR" "016"

# Age 3
extract_hexagon "34" "$BC" "033"
extract_hexagon "35" "$BC" "034"
extract_hexagon "30" "$BR" "029"
extract_hexagon "31" "$BC" "030"
extract_hexagon "28" "$BL" "031"
extract_hexagon "29" "$BR" "032"
extract_hexagon "26" "$TL" "027"
extract_hexagon "27" "$BC" "028"
extract_hexagon "32" "$BR" "025"
...
# Age 4
extract_hexagon "44" "$BR" "043"
extract_hexagon "45" "$TL" "044"
extract_hexagon "40" "$TL" "039"
extract_hexagon "41" "$BC" "040"
extract_hexagon "38" "$TL" "041"
extract_hexagon "39" "$BR" "042"
extract_hexagon "36" "$BC" "037"
extract_hexagon "37" "$BL" "038"
extract_hexagon "42" "$TL" "035"
extract_hexagon "43" "$BC" "036"

# Age 5
extract_hexagon "54" "$TL" "053"
extract_hexagon "55" "$BL" "054"
extract_hexagon "50" "$BC" "049"
extract_hexagon "51" "$BR" "050"
extract_hexagon "48" "$BC" "051"
...
# Age 6
extract_hexagon "64" "$BL" "063"
extract_hexagon "65" "$BC" "064"
extract_hexagon "60" "$BC" "059"
extract_hexagon "61" "$BR" "060"
extract_hexagon "58" "$BL" "061"
extract_hexagon "59" "$TL" "062"
extract_hexagon "56" "$BL" "057"
extract_hexagon "57" "$BC" "058"
extract_hexagon "62" "$BR" "055"
extract_hexagon "63" "$BL" "056"
...
extract_hexagon "74" "$TL" "073"
extract_hexagon "75" "$BR" "074"
extract_hexagon "70" "$TL" "069"
extract_hexagon "71" "$BR" "070"
extract_hexagon "68" "$BL" "071"
extract_hexagon "69" "$BR" "072"
extract_hexagon "66" "$BL" "067"
extract_hexagon "67" "$TL" "068"
extract_hexagon "72" "$BC" "065"
extract_hexagon "73" "$BR" "066"

# Age 8
extract_hexagon "84" "$BR" "083"
extract_hexagon "85" "$BC" "084"
extract_hexagon "80" "$TL" "079"
extract_hexagon "81" "$BR" "080"
extract_hexagon "78" "$BL" "081"
extract_hexagon "79" "$TL" "082"
extract_hexagon "76" "$TL" "077"
extract_hexagon "77" "$BC" "078"
extract_hexagon "82" "$TL" "075"
extract_hexagon "83" "$BR" "076"

# Age 9
extract_hexagon "94" "$BC" "093"
extract_hexagon "95" "$BL" "094"
extract_hexagon "90" "$BL" "089"
extract_hexagon "91" "$BR" "090"
extract_hexagon "88" "$TL" "091"
extract_hexagon "89" "$BR" "092"
extract_hexagon "86" "$TL" "087"
extract_hexagon "87" "$BR" "088"
extract_hexagon "92" "$TL" "085"
extract_hexagon "93" "$TL" "086"

# Age 10
extract_hexagon	"104" "$BR" "103"
extract_hexagon	"105" "$TL" "104"
extract_hexagon	"100" "$BR" "099"
extract_hexagon "101" "$BC" "100"
extract_hexagon "98" "$BR" "101"
extract_hexagon "99" "$TL" "102"
extract_hexagon "96" "$TL" "097"
extract_hexagon "97" "$BC" "098"
extract_hexagon "102" "$TL" "095"
extract_hexagon	"103" "$BL" "096"

# Age 11
extract_hexagon "114" "$BC" "113"
extract_hexagon "115" "$BR" "114"
extract_hexagon "110" "$BR" "109"
extract_hexagon "111" "$TL" "110"
extract_hexagon "108" "$BR" "111"
extract_hexagon "109" "$TL" "112"
extract_hexagon "106" "$TL" "107"
extract_hexagon "107" "$BL" "108"
extract_hexagon "112" "$BR" "105"
extract_hexagon "113" "$BC" "106"

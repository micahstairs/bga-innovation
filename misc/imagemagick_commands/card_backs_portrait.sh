...
mogrify -path temp -resize 110x150 \
    ...
    ../cards/Print_ArtifactsCards_back/Print_ArtifactsCards_back-0{0..9}6.png ../cards/Print_ArtifactsCards_back/Print_ArtifactsCards_back-107.png \
    ...
    ../cards/Print_EchoesCards_back/Print_EchoesCards_back-0{0..9}6.png ../cards/Print_ArtifactsCards_back/Print_ArtifactsCards_back-109.png \
...
magick montage \
    ...
    temp/Print_ArtifactsCards_back-0{0..9}6.png temp/Print_ArtifactsCards_back-107.png \
    temp/Print_CitiesCards_back-0{0..9}6.png temp/Print_ArtifactsCards_back-108.png \
    temp/Print_EchoesCards_back-0{0..9}6.png temp/Print_ArtifactsCards_back-109.png \

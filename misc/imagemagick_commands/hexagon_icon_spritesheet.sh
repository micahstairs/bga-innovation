...
magick montage $folder_path/{000..024}.png ../card_shapes/{blue,red,green,yellow,purple}_shape.png $folder_path/{025..034}.png ../special_achievement_icons/{empire,monument,universe,wonder,world}.png $folder_path/{035..044}.png ../special_achievement_icons//{empire,monument,universe,wonder,world}_portrait.png -trim -tile 15x4 -geometry 120x120+5+5 -background 'none' $folder_path/base_hexagon_spritesheet_15x.png

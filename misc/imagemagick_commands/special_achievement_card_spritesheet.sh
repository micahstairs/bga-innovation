...
magick montage $folder_path/base_special_achievement_{1..5}_cropped.png -tile 5x1 -geometry +5+5 -background 'white' $folder_path/special_achievement_card_spritesheet.png
...
magick montage $folder_path/base_special_achievement_{1..5}_cropped_rotated.png  -tile 5x1 -geometry +5+5 -background 'white' $folder_path/special_achievement_card_rotated_spritesheet.png

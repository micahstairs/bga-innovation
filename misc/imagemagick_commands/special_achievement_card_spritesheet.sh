...
magick convert "$folder_path/echoes_special_achievement_${heritage_num}.png" -crop 545x400${heritage_offset} +repage  -resize 450x330 "$folder_path/echoes_special_achievement_${heritage_num}_cropped.png"
...
magick convert "$folder_path/cities_special_achievement_${legend_num}.png" -crop 545x400${legend_offset} +repage  -resize 450x330 "$folder_path/cities_special_achievement_${legend_num}_cropped.png"
...
rm $folder_path/base_special_achievement_{1..5}_cropped.png  $folder_path/echoes_special_achievement_{1..5}_cropped.png $folder_path/figures_special_achievement_{1..5}_cropped.png $folder_path/cities_special_achievement_{1..5}_cropped.png

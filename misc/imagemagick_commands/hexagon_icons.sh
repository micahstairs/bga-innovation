...
magick montage \
  ...
  -trim -tile 15x1 -geometry 120x120+5+5 -background 'none' temp/base_hexagon_spritesheet_15x_1.png
...
magick montage \
  ...
  -trim -tile 10x1 -geometry 120x120+5+5 -background 'none' temp/base_hexagon_spritesheet_15x_2.png

# Place resized colorblind indicator shapes at the end of the second row of base hexagon icons.
magick montage temp/base_hexagon_spritesheet_15x_2.png \
  ...
  -trim -tile 6x1 -geometry +13+5 -background 'none' temp/base_hexagon_spritesheet_15x_2.png

# Build remaining 8 rows of base hexagon icons.
magick montage \
  temp/0{25..99}_base.png \
  temp/{100..104}_base.png \
  -trim -tile 10x8 -geometry 120x120+5+5 -background 'none' temp/base_hexagon_spritesheet_10x.png

# Combine all images into a single spritesheet.
magick montage \
  temp/base_hexagon_spritesheet_15x_{1..2}.png \
  temp/base_hexagon_spritesheet_10x.png \

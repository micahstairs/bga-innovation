...
$this->textual_card_infos = array(
    ...
    12  => array(
        ...
        'i_demand_effect_1_first_and_third' => clienttranslate('${I demand} you transfer a top card with a ${icon_4} from your board to my board if you have at least four ${icon_4} on your board! If you do, draw a ${age_1}!'),
        'i_demand_effect_1_fourth'          => clienttranslate('${I demand} you transfer a top card with a ${icon_4} from your board to my board if you have four ${icon_4} on your board! If you do, draw a ${age_1}!'),
    ),
    ...
    334 => array(
        ...
        'i_demand_effect_1_first_and_third' => clienttranslate('${I demand} you transfer a card with a ${icon_4} from your hand to my hand! If you do, draw a ${age_1}!'),
        'i_demand_effect_1_fourth'          => clienttranslate('${I demand} you transfer a card with a ${icon_4} or ${icon_3} from your hand to my hand! If you do, draw a ${age_1}!'),
    ),

    335 => array(
        'name'                                => clienttranslate('Plumbing'),
        'echo_effect_1_first_and_third'       => clienttranslate('Score a bottom card from your board.'),
        'echo_effect_1_fourth'                => clienttranslate('Score the bottom blue card from your board.'),
        'non_demand_effect_1_first_and_third' => clienttranslate('No effect.'),
    ...
    363 => array(
        ...
        'echo_effect_1_first_and_third'       => clienttranslate('Draw a ${age_3}.'),
        'echo_effect_1_fourth'                => clienttranslate('Return all cards from your forecast.'),
    ...
    373 => array(
        ...
        'i_demand_effect_1_first_and_third' => clienttranslate('${I demand} you draw and reveal three ${age_10}, total the number of ${icon_6} on them, and then return them! Transfer all cards of that value from your hand and score pile to my score pile!'),
        'i_demand_effect_1_fourth'          => clienttranslate('${I demand} you transfer all cards of value equal to the number of visible cards of the color of my choice on my board from your hand and your score pile to my score pile! Junk an available achievement of that value!'),
    ),
    ...
    388 => array(
        ...
        'i_demand_effect_1_fourth'          => clienttranslate('${I demand} you draw and tuck a ${age_6}! Transfer your top two cards of its color to my score pile! Score the bottom card of its color on my board!'),
    ),
    ...
    395 => array(
        ...
        'i_demand_effect_1_fourth'           => clienttranslate('${I demand} you transfer your highest top card to your hand!'),
    ...
    572 => array(
        ...
        'i_demand_effect_1'   => clienttranslate('${I demand} you reveal your hand! If each color present in my hand is present in yours, and vice versa, and your hand is not empty, I win!'),

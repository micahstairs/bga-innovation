    ...
    */
    ...
    function calculateIconHashForAllCards() {
        ...
        foreach ($cards as $card) {
            ...
            // TODO(CITIES and Echoes): Revisit formula.
            if ($card['id'] < 220 && $card['id'] > 440) { // Exclude cities for now.  Cities can only match themselves and some research would need to be done to verify whether it is possible for any of them to match each other
    ...
    function checkForSpecialAchievementsForPlayer($player_id) {
        ...
        foreach ($achievements_to_test as $achievement_id) {
            ...
            if ($achievement['owner'] != 0 || $achievement['location'] == 'removed') { // Somebody has already claimed that achievement or is no longer available

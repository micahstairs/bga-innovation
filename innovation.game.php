    ...
    */
    ...
    function notifyWithOnePlayerInvolved($card, $transferInfo, $progressInfo) {
        ...
        case 'deck->achievements':
            $message_for_player = clienttranslate('${You} draw and achieve ${<}${age}${>} ${<<}${name}${>>}.');
            $message_for_others = clienttranslate('${player_name} draws and achieves ${<}${age}${>} ${<<}${name}${>>}.');
            break;
        case 'hand->deck':
        ...
        case 'hand->achievements':
            ...
            $message_for_others = clienttranslate('${player_name} achieves ${<}${age}${>} ${<<}${name}${>>} from his hand.');
            break;
        ...
        case 'score->achievements':
            ...
            $message_for_others = clienttranslate('${player_name} achieves ${<}${age}${>} ${<<}${name}${>>} from his score pile.');
            break;
    ...
    function getTransferInfoWithOnePlayerInvolved($location_from, $location_to, $player_id_is_owner_from, $bottom_to, $you_must, $player_must, $player_name, $number, $cards, $targetable_players) {
        ...
        if ($location_from == $location_to && $location_from == 'board') { // Used only for Self service
            ...
            case 'score->achievements':
                ...
                $message_for_others = clienttranslate('{player must} tranachievesfer {number} {card} from his score pile');
                break;
    ...
    function notifyWithTwoPlayersInvolved($card, $transferInfo, $progressInfo) {
        ...
        if ($owner_from == 0 || $owner_to == 0) { // Used only for Rocketry or Fission or Mass media
            ...
            case 'hand->achievements':
                ...
                $message_for_opponent = clienttranslate('${player_name} transfers ${<}${age}${>} ${<<}${name}${>>} from his hand to ${your} achievements.');
            ...
            case 'board->achievements':
                ...
                $message_for_others = clienttranslate('${player_name} transfers a ${<}${age}${>} from his board to ${opponent_name}\'s achievements.');
                break;
            ...
            case 'score->achievements':
                ...
                $message_for_opponent = clienttranslate('${player_name} transfers ${<}${age}${>} ${<<}${name}${>>} from his score pile to ${your} achievements.');
            ...
            case 'hand->achievements':
                $message_for_player = clienttranslate('${You} transfer ${<}${age}${>} ${<<}${name}${>>} from ${opponent_name}\'s hand to your achievements.');

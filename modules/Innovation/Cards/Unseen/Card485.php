...
class Card485 extends AbstractCard
{
  ...
  // Pilgrimage:
  //   - You may return a card of value [1] from your hand. If you do, safeguard an available
  //     achievement of value equal to the returned card, then repeat this effect using a value
  //     one higher.
  ...
  public function getInteractionOptions(): array
  {
    if (self::isFirstNonDemand()) {
      if (self::isFirstInteraction()) {
        return self::youMay()->return()->value(self::getAuxiliaryValue())->fromYourHand()->build();
      } else {

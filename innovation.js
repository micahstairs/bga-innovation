    ...
    return declare("bgagame.innovation", ebg.core.gamegui, {
        ...
        */
        ...
        getCardHTMLClass : function(id, age, type, is_relic, card, zone_HTML_class) {
            var simplified_graphics_enabled = this.prefs[110].value == 2;
            ...
            if (simplified_graphics_enabled) {
        ...
        createCard : function(id, age, type, is_relic, zone_HTML_class, card) {
            ...
            if (card === null) {
                if (age === null || !simplified_graphics_enabled) {
                    var HTML_inside = '';
                } else {
            ...
            var graphics_class = simplified_graphics_enabled ? "simplified_card_back" : "default_card_back";

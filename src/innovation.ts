...
function (dojo, declare) {
    return declare("bgagame.innovation", ebg.core.gamegui, {
        ...
        onUpdateActionButtons: function (stateName, args) {
            if(this.isCurrentPlayerActive()) {            
                ...
                case 'selectionMove':
                    ...
                    let last_button_id: string = null;
        ...
        */
        ...
        getBonusIconValue : function(icon : number) {
        ...
        selectMyCardBacksInForecast : function(max_age_to_promote: number) {
            if (max_age_to_promote == null) {
        ...
        getCardHTMLId : function(id, age, type, is_relic, zone_HTML_class) : string{
        ...
        writeOverCard : function(card, size, HTML_id): string {
        ...
        setPlacementRules : function(zone, left_to_right : boolean) {
            let self = this;

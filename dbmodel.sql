...
CREATE TABLE IF NOT EXISTS `card` (
  ...
  `spot_1` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_2` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_3` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_4` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_5` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_6` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',

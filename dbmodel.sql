...
CREATE TABLE IF NOT EXISTS `card` (
  ...
  `spot_1` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 15 (junk achievement), 16 (junk plus and double plus), 17 (unsplay), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_2` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 15 (junk achievement), 16 (junk plus and double plus), 17 (unsplay), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',

...
CREATE TABLE IF NOT EXISTS `card` (
  ...
  `spot_1` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_2` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_3` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_4` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_5` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
  `spot_6` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Icon on bottom-left, 0 (hexagon), 1 (crown), 2 (leaf), 3 (bulb), 4 (tower), 5 (factory), 6 (clock), 7 (avatar), 8 (flag), 9 (fountain), 10 (echo), 11 (left), 12 (right), 13 (up), 14 (plus), 101-111 (1-11 bonus) or NULL for no icon (e.g. special achievement)',
...
(228, 2, 1, 2, 3, 3, 3, 1, 0, 14, 3, 'removed'),
...
(243, 2, 2, 4,   3,   3,   2, 102, 0, 14, 3, 'removed'),
(244, 2, 2, 4, 102,   3,   3,   4, 0,  3, 3, 'removed'),

/* Cities - Age 3 */
(245, 2, 3, 0,   3,   3,   3,   4, 0,  14, 3, 'removed'),
...
(258, 2, 4, 1,   5,   5,  14,   3, 0,  14, 5, 'removed'),
...
(269, 2, 5, 2,   4,   2,  14,   4, 0,  14, 4, 'removed'),
...
/* Cities - Age 8 */
(295, 2, 8, 0,   5,   5,  14,   3, 0,  14, 5, 'removed'),
...
(313, 2, 9, 4,   5,   6,  14,   5, 0,  13, 5, 'removed'),
(314, 2, 9, 4,   2,   3,  14,   2, 0,   9, 2, 'removed'),

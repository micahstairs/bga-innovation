...
(98, 0, 10, 1, 0, 5, 7, 5, 5),
(99, 0, 10, 2, 0, 6, 6, 6, 6),
(100, 0, 10, 2, 0, 1, 7, 1, 1),
(101, 0, 10, 3, 0, 5, 5, 5, 5),
(102, 0, 10, 3, 0, 2, 2, 2, 2),
(103, 0, 10, 4, 3, 3, 6, 0, 3),
(104, 0, 10, 4, 0, 6, 7, 7, 7),

/* Age 11 */
(440, 0, 11, 0, 2, 0, 2, 2, 2),
(441, 0, 11, 0, 6, 3, 3, 0, 3),
(442, 0, 11, 1, 1, 0, 5, 5, 5),
(443, 0, 11, 1, 6, 6, 6, 0, 6),
(444, 0, 11, 2, 5, 5, 3, 0, 5),
(445, 0, 11, 2, 1, 1, 6, 0, 1),
(446, 0, 11, 3, 0, 1, 7, 7, 7),
(447, 0, 11, 3, 1, 2, 0, 2, 2),
(448, 0, 11, 4, 7, 0, 7, 7, 7),
...
(206, 1, 10, 0, 7, 7, 7, 0, 7, 'removed'),
(207, 1, 10, 1, 5, 0, 5, 5, 5, 'removed'),
(208, 1, 10, 1, 6, 0, 6, 6, 6, 'removed'),
(209, 1, 10, 2, 5, 5, 0, 6, 5, 'removed'),
(210, 1, 10, 2, 6, 6, 6, 0, 6, 'removed'),
(211, 1, 10, 3, 0, 6, 2, 6, 6, 'removed'),
(212, 1, 10, 3, 2, 7, 0, 2, 2, 'removed'),
(213, 1, 10, 4, 0, 6, 6, 6, 6, 'removed'),
(214, 1, 10, 4, 0, 1, 1, 1, 1, 'removed'),

/* Artifacts - Age 11 */
(450, 1, 11, 0, 2, 0, 2, 3, 3, 'removed'),
(451, 1, 11, 0, 7, 7, 7, 0, 7, 'removed'),
(452, 1, 11, 1, 5, 5, 5, 0, 5, 'removed'),
(453, 1, 11, 1, 0, 1, 6, 1, 1, 'removed'),
(454, 1, 11, 2, 2, 6, 0, 2, 2, 'removed'),
(455, 1, 11, 2, 3, 0, 7, 3, 3, 'removed'),
...
(426, 3,10, 0,  3, 10,110,  0, 3, 'removed'),
(427, 3,10, 1,  0,  6,  6,  5, 6, 'removed'),
(428, 3,10, 1,  0,110,  7, 10, 7, 'removed'),
(429, 3,10, 2,  1,  0,  6,  6, 6, 'removed'),
(430, 3,10, 2,  5,  5,  0,  5, 5, 'removed'),
(431, 3,10, 3,  6,  0,110, 10, 6, 'removed'),
(432, 3,10, 3,  7,110, 10,  0, 7, 'removed'),
(433, 3,10, 4, 10,  1,  0,  1, 1, 'removed'),
(434, 3,10, 4,  3,  0, 10,111, 3, 'removed'),

/* Echoes - Age 11 */
(470, 3,11, 0,111,  1,  1,  0, 1, 'removed'),
(471, 3,11, 0,  0,111,  3,  3, 3, 'removed'),
(472, 3,11, 1,  2,  6,  6,  0, 6, 'removed'),
(473, 3,11, 1,  5,  0,  6,  5, 5, 'removed'),
(474, 3,11, 2,  0,  6,  6,111, 6, 'removed'),
(475, 3,11, 2,  5,  5,111,  0, 5, 'removed'),
(476, 3,11, 3,  0,  2,  6,  2, 2, 'removed'),
(477, 3,11, 3,112,  7,  0,  7, 7, 'removed'),
(478, 3,11, 4,  0,  3,  7,  7, 7, 'removed'),
(479, 3,11, 4,  3,  0,  3,112, 3, 'removed');
...
(221, 2, 1, 0, 1, 1, 1, 4, 0, 15, 1, 'removed'),
(222, 2, 1, 0, 2, 2, 2, 2, 0,  4, 2, 'removed'),
(223, 2, 1, 1, 1, 1, 1, 3, 0,  3, 1, 'removed'),
(224, 2, 1, 1, 2, 2, 2, 1, 0, 14, 2, 'removed'),
(225, 2, 1, 1, 3, 3, 3, 2, 0, 14, 3, 'removed'),
(226, 2, 1, 2, 4, 3, 3, 4, 0,  4, 4, 'removed'),
(227, 2, 1, 2, 4, 2, 4, 4, 0,  4, 4, 'removed'),
(228, 2, 1, 2, 3, 3, 3, 1, 0, 16, 3, 'removed'),
...
(233, 2, 1, 4, 2, 2, 2, 4, 0, 14, 2, 'removed'),
(234, 2, 1, 4, 1, 1, 1, 4, 0, 14, 1, 'removed'),

/* Cities - Age 2 */
(235, 2, 2, 0,   1, 102,   1,   3, 0, 14, 1, 'removed'),
(236, 2, 2, 0,   1,   3,   1,   1, 0, 14, 1, 'removed'),
(237, 2, 2, 1,   4,   5,   4,   4, 0, 15, 4, 'removed'),
...
(276, 2, 6, 0,   3,   5,  14,   3, 0,  14, 3, 'removed'),
(277, 2, 6, 1,   5,   6,  14,   6, 0,  14, 6, 'removed'),
...
(282, 2, 6, 3,   5,   2,  12,   5, 0,  15, 5, 'removed'),
...
(296, 2, 8, 0,   5,   6,  14, 5, 0,  14, 1, 'removed'),
(297, 2, 8, 1,   5,   5,   6, 5, 0,   9, 5, 'removed'),
(298, 2, 8, 1, 109,   5, 109, 3, 0, 109, 5, 'removed'),
(299, 2, 8, 2,   1,   6,   6, 6, 0,  15, 6, 'removed'),
(300, 2, 8, 2, 108, 108,   1, 2, 0, 108, 2, 'removed'),
(301, 2, 8, 3, 108, 108,   6, 2, 0, 108, 2, 'removed'),
(302, 2, 8, 3,   2,   1,   2, 2, 0,   9, 2, 'removed'),
(303, 2, 8, 4, 109,   6, 109, 3, 0, 109, 6, 'removed'),
(304, 2, 8, 4,   1,   3,  14, 3, 0,  14, 3, 'removed'),

/* Cities - Age 9 */
(305, 2, 9, 0, 110,   6, 110,   1, 0, 110, 6, 'removed'),
(306, 2, 9, 0,   6,   6,  13,   3, 0,   9, 6, 'removed'),
(307, 2, 9, 1,   5,   6,  14,   6, 0,  13, 6, 'removed'),
(308, 2, 9, 1, 110,   5, 110,   1, 0, 110, 5, 'removed'),
(309, 2, 9, 2, 109, 109,   6,   3, 0, 109, 5, 'removed'),
(310, 2, 9, 2,   3,   1,  13,   1, 0,   9, 1, 'removed'),
(311, 2, 9, 3,   2,   6,  14,   6, 0,  13, 6, 'removed'),
(312, 2, 9, 3, 109,   1, 109,   2, 0, 109, 2, 'removed'),
(313, 2, 9, 4,   5,   6,  16,   5, 0,  13, 5, 'removed'),
(314, 2, 9, 4,   2,   3,  15,   2, 0,   9, 2, 'removed'),

/* Cities - Age 10 */
(315, 2,10, 0,   2,   2,  13,   3, 0,  17, 2, 'removed'), 
(316, 2,10, 0, 110,   6,   6,   3, 0,  14, 6, 'removed'),
(317, 2,10, 1,   5, 110,   5,   1, 0,  14, 5, 'removed'),
(318, 2,10, 1,   7,   7,  13,   7, 0,  17, 6, 'removed'),
(319, 2,10, 2,   3,   6,  13,   6, 0,  17, 6, 'removed'),
(320, 2,10, 2,   6,   1, 111, 111, 0, 111, 1, 'removed'),
(321, 2,10, 3,   2,   6,  13,   2, 0,  17, 2, 'removed'),
(322, 2,10, 3, 110,   1,   6,   1, 0,  14, 1, 'removed'),
(323, 2,10, 4,   5,   7,   5,   5, 0,  15, 5, 'removed'),
(324, 2,10, 4,   2,   3,  13,   3, 0,  17, 3, 'removed'),

/* Cities - Age 11 */
(460, 2, 11, 0,   3,   3,   9,   6, 0,   9, NULL, 'removed'),
(461, 2, 11, 0,   5,   5, 111,   7, 0,  17, NULL, 'removed'),
(462, 2, 11, 1,   1,   5,   9,   5, 0,   9, NULL, 'removed'),
(463, 2, 11, 1,   6, 111,   3,   6, 0,  17, NULL, 'removed'),
(464, 2, 11, 2,   1,   7,   1, 111, 0,  17, NULL, 'removed'),
(465, 2, 11, 2,   6, 112,   1, 112, 0, 112, NULL, 'removed'),
(466, 2, 11, 3,   5,   2,   9,   2, 0,   9, NULL, 'removed'),
(467, 2, 11, 3, 111,   6,   6,   6, 0,  17, NULL, 'removed'),
(468, 2, 11, 4,   3,   2, 111,   3, 0,  17, NULL, 'removed'),
(469, 2, 11, 4,   7, 111, 111,   2, 0, 111, NULL, 'removed');
...
/* Unseen - Age 10 */
(575, 5, 10, 0, 0, 7, 7, 3, 7),
(576, 5, 10, 0, 6, 0, 6, 6, 6),
(577, 5, 10, 1, 0, 7, 7, 2, 7),
(578, 5, 10, 1, 3, 3, 0, 7, 3),
(579, 5, 10, 2, 1, 5, 5, 0, 5),
(580, 5, 10, 2, 1, 1, 0, 7, 1),
(581, 5, 10, 3, 6, 6, 6, 0, 6),
(582, 5, 10, 3, 0, 2, 5, 2, 2),
(583, 5, 10, 4, 3, 6, 6, 0, 6),
(584, 5, 10, 4, 0, 5, 3, 3, 3),
...
/* Unseen - Age 11 */
(585, 5, 11, 0, 2, 2, 7, 0, 2),
(586, 5, 11, 0, 6, 6, 0, 6, 6),
(587, 5, 11, 1, 0, 3, 5, 3, 3),
(588, 5, 11, 1, 5, 0, 6, 6, 6),
(589, 5, 11, 2, 5, 5, 5, 0, 5),
(590, 5, 11, 2, 0, 1, 1, 1, 1),
(591, 5, 11, 3, 6, 1, 6, 0, 6),
(592, 5, 11, 3, 0, 2, 2, 2, 2),
(593, 5, 11, 4, 7, 7, 0, 7, 7),
(594, 5, 11, 4, 3, 7, 7, 0, 7);
